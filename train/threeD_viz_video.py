...
# tile_pos = np.array([[-399.9818, 1729.5521, 487.66082],
#                      [-279.5209, 1494.4893, 265.35904],
#                      [259.62896, 1896.4289, 357.17709],
#                      [99.98375, 2188.0678, 619.93435]])
...
def generateVideo(data, path, heatmap, tile_coord=tile_pos):
    ...
    for i in range(keypoint_GT.shape[0]):
        ...
        img5 = cv2.resize(plotKeypoint(data, scale=19, tactile=False, tile_coord=tile_coord, tactile_frame=tactile_frame
