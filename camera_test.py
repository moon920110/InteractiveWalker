...
def detect_obstacles(depth_frame, threshold=3.0):
...
try:
    while True:
        ...
        average_distance = compute_distance(depth_image, obstacle_mask)
        ...
        if average_distance is not None:
            print(f"Average distance of obstacles within 3 meters: {average_distance:.2f} meters")
        else:
            print("No obstacles within 3 meters detected.")
