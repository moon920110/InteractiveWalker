        ...
        while not self.stop_event.is_set():
            ...
            if mode == 'full':
                if self.STS_flag:
                    ...
                    command = 'S1 ' + str(min(int(1400 * self.forback * self.left_turn_scale * (1 - 2 * self.leftright)), 200)) + \
                              ',S2 ' + str(min(int(1400 * self.forback * self.right_turn_scale * (1 - 2 * self.leftright)), 200)) + ",D1 0,D2 0,"
