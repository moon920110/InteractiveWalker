...
class Brain:
	...
	def think(self):
		if self.start_signal == 1:
			...
			temp = np.array([self.base_image[21:,:]/100, self.base_image[21:,:]/100, self.base_image[21:,:]/100], dtype='uint8')
			_, right_arm_cnts, _ = cv2.findContours(temp, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)
